...
struct DashboardPanelView: View {
    ...
    var body: some View {
        ...
        .onChange(of: availableProviders) { _, newProviders in
            ...
            DebugFlowLogger.shared.log(
                stage: .display,
                message: "dashboard.providers.changed",
        ...
        .onChange(of: selectedProvider) { _, newProvider in
            DebugFlowLogger.shared.log(
                stage: .display,
                message: "dashboard.provider.selected",
    ...
    private func detailSheet(for destination: DetailSheet) -> some View {
        ...
        case .usage:
            if let provider = displayedProvider {
                DashboardDetailSheet(title: "Usage") {
    ...
    private func refreshData() {
        ...
        DebugFlowLogger.shared.log(
            stage: .display,
            message: "dashboard.refresh.tapped",
...
private struct DashboardDetailSheet<Content: View>: View {
    let title: String
