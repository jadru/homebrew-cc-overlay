...
**Codex**와 **Claude Code** 사용자를 위한 펫 우선 macOS 메뉴바 동반자. 새로 관측된 작업만 펫의 영구 성장으로 바꾸고, 사용량 신호는 다음 실행을 위한 조용한 가드레일로 제공합니다.
...
- **획득형 펫 성장** — 새로 관측된 토큰 활동만 펫 성장·장비·입양 티켓으로 이어지며, 클릭만으로 작업 보상을 만들 수 없음
